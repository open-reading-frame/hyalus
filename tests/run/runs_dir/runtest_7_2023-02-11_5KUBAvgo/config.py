"""Runs a function and then a few assertions that should pass"""
...
from hyalus.config.steps import RunFunctionStep, AssertValuesContain
from hyalus.config.tags import Long
...
STEPS = [
    ...
    AssertValuesContain("output/food.json", "Mexican"),
    AssertValuesContain("output/coffee.json", "Ozo"),
]

TAGS = [Long(info="Should take a while")]
