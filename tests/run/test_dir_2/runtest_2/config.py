"""Runs a function which should error with given input"""
...
from hyalus.config.tags import Short
...
STEPS = [
    ...
    RunFunctionStep(custom_func, "output/coffee.json", {"best_coffee_shop"}),
